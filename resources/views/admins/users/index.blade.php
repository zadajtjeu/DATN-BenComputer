                        ...
                        @if ($users->isNotEmpty())
                            @foreach ($users as $key => $user)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.users.edit', $user->id)}}" class="btn btn-xs btn-primary">{{ __('Edit') }}</a>

                                        <form style="display: inline;" action="{{ route('admin.users.destroy', $user->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-xs btn-danger" type="submit" onclick="return confirm('{{ __('Comfirm Delete') }}');">{{ __('Delete') }}</button>
                                        </form>
