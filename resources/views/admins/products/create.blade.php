            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required onkeyup="ChangeToSlug()">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="promotion_price" name="promotion_price" class="form-control @error('promotion_price') is-invalid @enderror" value="{{ old('promotion_price') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select id="category_id" name="category_id" class="form-control custom-select @error('category_id') is-invalid @enderror" required>
                            @foreach ($categories as $key => $category)
                                @include('layouts.admins.components.categoryoptionchoose', ['subcategory' => $category, 'prefix' => '', 'old_cate' => old('category_id')])
                            @endforeach
                        </select>
                        @error('category_id')
                            <span class="error invalid-feedback" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="specifications" name="specifications" class="form-control">{{ old('specifications') }}</textarea>
                    ...
                    <div class="form-group form-upload">
                        ...
                        <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image[]" accept="image/*" multiple required>
                        @error('image')
                            <span class="error invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
