...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
    @if ($order->status == \App\Enums\OrderStatus::NEW_ORDER)
        {{ __('Order #:code recently added', ['code' =>$order->order_code]) }}
    @elseif ($order->status == \App\Enums\OrderStatus::IN_PROCCESS)
        {{ __('Order #:code has been approved', ['code' =>$order->order_code]) }}
    @elseif ($order->status == \App\Enums\OrderStatus::IN_SHIPPING)
        {{ __('Order #:code in transit', ['code' =>$order->order_code]) }}
    @elseif ($order->status == \App\Enums\OrderStatus::COMPLETED)
        {{ __('Order #:code is completed', ['code' =>$order->order_code]) }}
    @elseif ($order->status == \App\Enums\OrderStatus::CANCELED)
        {{ __('Order #:code is canceled', ['code' =>$order->order_code]) }}
    @endif
</p>
...
<a href="{{ route('user.orderdetails', $order->id)}}" class="button button-primary" target="_blank" rel="noopener" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #2d3748; border-bottom: 8px solid #2d3748; border-left: 18px solid #2d3748; border-right: 18px solid #2d3748; border-top: 8px solid #2d3748;">{{ __('Click here to view your order') }}</a>
</td>
</tr>
</table>
</td>
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">© 2022 BenComputer. All rights reserved.</p>
