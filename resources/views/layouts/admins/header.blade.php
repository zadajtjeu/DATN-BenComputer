...
<head>
    ...
    <title>@yield('title', config('app.name', 'Ben Computer')) | {{ __('Dashboard') }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('templates/adminlte/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('templates/adminlte/plugins/overlayScrollbars/css/OverlayScrollbars.min.cs') }}s">
